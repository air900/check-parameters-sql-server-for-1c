    ...
    FROM (
        SELECT
            ...
            CASE
                ...
                WHEN c.relname ~ '^_accumreg[0-9]+totals$'   THEN 'accumreg_totals'
                WHEN c.relname ~ '^_accumreg[0-9]+'          THEN 'accumreg_movements'
                WHEN c.relname ~ '^_inforeg[0-9]+'           THEN 'inforeg'
                WHEN c.relname ~ '^_accreg[0-9]+'            THEN 'accreg'
                WHEN c.relname ~ '^_calcreg[0-9]+'           THEN 'calcreg'
                WHEN c.relname ~ '^_chrc[0-9]+'              THEN 'chrc'
                WHEN c.relname ~ '^_accchrt[0-9]+'           THEN 'accchrt'
