...
function Test-MssqlConnection {
    ...
    # '-W' убран: конфликтует с '-y/-Y' (Invoke-SqlcmdRaw); trim делаем в ConvertFrom-MssqlPipeOutput.
...
function Invoke-MssqlSqlDiagnostic {
    ...
    # '-W' убран: конфликтует с '-y/-Y'; trim в ConvertFrom-MssqlPipeOutput.
