...
if (Test-Path $RootPath) {
    Write-Output "Removing previous install at $RootPath ..."
    # Retry once if first attempt fails -- a freshly-stopped task may still
    # be releasing file handles for a second or two.
